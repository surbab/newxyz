...
<?php echo $this->Form->create('DelChalan'); ?>
	<fieldset>
		<legend><?php echo __('Edit Del Chalan'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DelChalan.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DelChalan.id'))); ?></li>
