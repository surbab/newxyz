...
<?php echo $this->Form->create('DelChalanDet'); ?>
	<fieldset>
		<legend><?php echo __('Edit Del Chalan Det'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DelChalanDet.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DelChalanDet.id'))); ?></li>
