...
<?php echo $this->Form->create('TaxType'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tax Type'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TaxType.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('TaxType.id'))); ?></li>
