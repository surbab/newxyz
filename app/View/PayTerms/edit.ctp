...
<?php echo $this->Form->create('PayTerm'); ?>
	<fieldset>
		<legend><?php echo __('Edit Pay Term'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PayTerm.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PayTerm.id'))); ?></li>
