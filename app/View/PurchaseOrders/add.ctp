...
<?php echo $this->Form->create('PurchaseOrder'); ?>
	...
	<?php
		...
		echo $this->Form->input('po_no',array('label' =>'PurchaseOrder No'));
		echo $this->Form->input('partner_id',array('label' =>'Partner Name', 'options' => $partner));
		echo $this->Form->input('po_date',array('label' =>'PurchaseOrder Date'));
	...
	<?php
//		echo $this->Form->input('tot_value', array('label' =>'Total PurchaseOrder', 'readonly'=>"readonly"));
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List PurchaseOrder Dets'), array('controller' => 'po_dets', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New PurchaseOrder Det'), array('controller' => 'po_dets', 'action' => 'add')); ?> </li>
	</ul>
</div>
<script>
