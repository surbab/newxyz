...
<?php echo $this->Form->create('SaleEng'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sale Eng'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SaleEng.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SaleEng.id'))); ?></li>
