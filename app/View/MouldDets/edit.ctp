<div class="mouldDets form">
<?php echo $this->Form->create('MouldDet'); ?>
	<fieldset>
		<legend><?php echo __('Edit Mould Det'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('asset_code_id');
		echo $this->Form->input('mould_life_est');
		echo $this->Form->input('no_cav');
		echo $this->Form->input('dwg_no');
		echo $this->Form->input('co_own');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MouldDet.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MouldDet.id'))); ?></li>
