...
<?php echo $this->Form->create('GrnDet'); ?>
	<fieldset>
		<legend><?php echo __('Edit Grn Det'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('GrnDet.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('GrnDet.id'))); ?></li>
