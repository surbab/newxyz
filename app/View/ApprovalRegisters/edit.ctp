...
<?php echo $this->Form->create('ApprovalRegister'); ?>
	<fieldset>
		<legend><?php echo __('Edit Approval Register'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ApprovalRegister.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ApprovalRegister.id'))); ?></li>
