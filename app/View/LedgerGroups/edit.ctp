...
<?php echo $this->Form->create('LedgerGroup'); ?>
	<fieldset>
		<legend><?php echo __('Edit Ledger Group'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('LedgerGroup.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('LedgerGroup.id'))); ?></li>
