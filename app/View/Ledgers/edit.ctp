...
<?php echo $this->Form->create('Ledger'); ?>
	<fieldset>
		<legend><?php echo __('Edit Ledger'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Ledger.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Ledger.id'))); ?></li>
