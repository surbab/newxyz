...
<?php echo $this->Form->create('ApprovalRegisterDet'); ?>
	<fieldset>
		<legend><?php echo __('Edit Approval Register Det'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ApprovalRegisterDet.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ApprovalRegisterDet.id'))); ?></li>
