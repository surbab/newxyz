...
<?php echo $this->Form->create('SaleAgent'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sale Agent'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SaleAgent.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SaleAgent.id'))); ?></li>
