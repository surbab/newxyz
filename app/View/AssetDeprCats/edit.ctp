...
<?php echo $this->Form->create('AssetDeprCat'); ?>
	<fieldset>
		<legend><?php echo __('Edit Asset Depr Cat'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('AssetDeprCat.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('AssetDeprCat.id'))); ?></li>
