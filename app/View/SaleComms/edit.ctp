...
<?php echo $this->Form->create('SaleComm'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sale Comm'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SaleComm.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SaleComm.id'))); ?></li>
