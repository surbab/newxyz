...
<?php echo $this->Form->create('SalInvDet'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sal Inv Det'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SalInvDet.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SalInvDet.id'))); ?></li>
