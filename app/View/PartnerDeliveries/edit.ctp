...
<?php echo $this->Form->create('PartnerDelivery'); ?>
	<fieldset>
		<legend><?php echo __('Edit Partner Delivery'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PartnerDelivery.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PartnerDelivery.id'))); ?></li>
