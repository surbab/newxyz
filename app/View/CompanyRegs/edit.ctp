...
<?php echo $this->Form->create('CompanyReg'); ?>
	<fieldset>
		<legend><?php echo __('Edit Company Reg'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CompanyReg.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('CompanyReg.id'))); ?></li>
