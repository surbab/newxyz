...
<?php echo $this->Form->create('PoDet'); ?>
	<fieldset>
		<legend><?php echo __('Edit Po Det'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PoDet.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('PoDet.id'))); ?></li>
