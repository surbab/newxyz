...
<?php echo $this->Form->create('ResourceWc'); ?>
	<fieldset>
		<legend><?php echo __('Edit Resource Wc'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ResourceWc.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ResourceWc.id'))); ?></li>
