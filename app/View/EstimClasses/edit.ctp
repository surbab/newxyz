...
<?php echo $this->Form->create('EstimClass'); ?>
	<fieldset>
		<legend><?php echo __('Edit Estim Class'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EstimClass.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('EstimClass.id'))); ?></li>
