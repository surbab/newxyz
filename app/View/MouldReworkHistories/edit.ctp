...
<?php echo $this->Form->create('MouldReworkHistory'); ?>
	<fieldset>
		<legend><?php echo __('Edit Mould Rework History'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MouldReworkHistory.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MouldReworkHistory.id'))); ?></li>
