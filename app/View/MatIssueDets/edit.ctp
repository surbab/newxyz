...
<?php echo $this->Form->create('MatIssueDet'); ?>
	<fieldset>
		<legend><?php echo __('Edit Mat Issue Det'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('MatIssueDet.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('MatIssueDet.id'))); ?></li>
